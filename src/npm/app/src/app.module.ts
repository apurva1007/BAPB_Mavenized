...
@NgModule({
	...
	declarations:[AddCarComponent,AppComponent,HomeComponent,RegisterComponent,SearchCarComponent,CarDetailsComponent, AddBidComponent,AllBidsComponent,ShowSoldCarsComponent],
